...
INDEX_COUPON_PREFIX = "ptest_seek0_coupon_"
INDEX_SHOP_PREFIX = "ptest_seek0_shop_"
INDEX_LANDMARK_PREFIX = "ptest_seek0_landmark_"

INDEX_LANDMARK_SHOP_COUPON_PREFIX = "ptest_seek0_landmark_shop_coupon_"
...
# coupon
INDEX_COUPON_LIST = [
    "ptest_seek0_coupon_hangzhou",
    "ptest_seek0_coupon_shanghai",
    "ptest_seek0_coupon_qingdao",
    "ptest_seek0_coupon_xiamen",
    "ptest_seek0_coupon_wuhan",
    "ptest_seek0_coupon_chengdu",
    "ptest_seek0_coupon_taizhou"
]

# shop
INDEX_SHOP_LIST = [
    "ptest_seek0_shop_hangzhou",
    "ptest_seek0_shop_shanghai",
    "ptest_seek0_shop_qingdao",
    "ptest_seek0_shop_xiamen",
    "ptest_seek0_shop_wuhan",
    "ptest_seek0_shop_chengdu",
    "ptest_seek0_shop_taizhou"
]

# landmark
INDEX_LANDMARK_LIST = [
    "ptest_seek0_landmark_hangzhou",
    "ptest_seek0_landmark_shanghai",
    "ptest_seek0_landmark_qingdao",
    "ptest_seek0_landmark_xiamen",
    "ptest_seek0_landmark_wuhan",
    "ptest_seek0_landmark_chengdu",
    "ptest_seek0_landmark_taizhou"
]
...
INDEX_LANDMARK_SHOP_COUPON_LIST = [
    "ptest_seek0_landmark_shop_coupon_hangzhou",
    "ptest_seek0_landmark_shop_coupon_shanghai",
    "ptest_seek0_landmark_shop_coupon_qingdao",
    "ptest_seek0_landmark_shop_coupon_xiamen",
    "ptest_seek0_landmark_shop_coupon_wuhan",
    "ptest_seek0_landmark_shop_coupon_chengdu",
    "ptest_seek0_landmark_shop_coupon_taizhou"
]
