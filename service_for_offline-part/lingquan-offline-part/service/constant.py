...
# shopping
INDEX_SHOPPING_LIST = [
    "pre_seek0_shopping_hangzhou",
    "pre_seek0_shopping_shanghai",
    "pre_seek0_shopping_qingdao",
    "pre_seek0_shopping_xiamen",
    "pre_seek0_shopping_wuhan",
    "pre_seek0_shopping_chengdu",
    "pre_seek0_shopping_taizhou"
]

# landmark shopping
INDEX_LANDMARK_SHOPPING_LIST = [
    "pre_seek0_landmark_shopping_hangzhou",
    "pre_seek0_landmark_shopping_shanghai",
    "pre_seek0_landmark_shopping_qingdao",
    "pre_seek0_landmark_shopping_xiamen",
    "pre_seek0_landmark_shopping_wuhan",
    "pre_seek0_landmark_shopping_chengdu",
    "pre_seek0_landmark_shopping_taizhou"
]
